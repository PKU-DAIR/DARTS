...
#MODEL_PATH=${MODEL_PATH:-"////mymodel/qwen30bmoe-rl"}
MODEL_PATH=${MODEL_PATH:-"////mymodel/qwen30bmoe-rl-ours"}
...
TRAIN_FILE=${TRAIN_FILE:-"////data/dapo-math-512.parquet"}
#TRAIN_FILE=${TRAIN_FILE:-"////data/data/dapo-math-17k.parquet"}
...
offload=True
gen_tp=4
fsdp_size=$((NGPUS_PER_NODE * NNODES))
yita=1
...
python -m recipe.rllab.main_dapo \
