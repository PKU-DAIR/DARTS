...
export ENABLE_ENTROPY_REBRANCH=1

project_name='test'
exp_name='3b-math-mix'
trainer_name='basic'
...
MODEL_PATH=${MODEL_PATH:-"////model/Qwen2.5-3B"}
...
TRAIN_FILE=${TRAIN_FILE:-"////data/mixed_dapo_format.parquet"}
...
python -m recipe.cogrpo.main_ppo \
    ...
    algorithm.redundancy=${redundancy} \
